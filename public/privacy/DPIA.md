...
| R4 | Children below local minimum age use the App and have sensitive data processed. | Medium | High | **Medium** — self-attestation at onboarding, COPPA-style deletion on report (§14). **Pending (separate audit):** stronger age-gate (parental consent flow) for sub-13 users. |
