...
const steps = [
  ...
  {
    n: "Mentor",
    p: "Arya reads your journal, remembers your commitments, and responds to your moment — not a script. Share a photo, request a weekly letter, or just talk. Wisdom without judgment.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" aria-hidden>
